function [U_out, phase_screen_used] = turbulent_prop(U_in, sim_reg, L, Cn2, D0, d0, n_screen, phase_screen_old, corr_coeff, lambda)
...
%       phase screen used during the execution of the split step method
    ...
    for i = 1:n_screen
        phase_screen_used(:, :, i) = phase_screen_MVKS(sim_reg, Cn2, D0, d0, dL);
    end
